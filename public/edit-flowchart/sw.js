...
const PRECACHE_URLS = [
  '/edit-flowchart/',
  '/edit-flowchart/manifest.json',
  '/edit-flowchart/icon-192.png',
  '/edit-flowchart/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/edit-flowchart/manifest.json';
}
